...
public class LogAnalyzer {
    ...
    public static void main(String[] args) {
        ...
        String serverLogs = "2024-12-10 16:05:30.339309 - Application: ReportGen - Log Level: DEBUG - Operation completed successfully.:::" +
                "2024-12-10 15:29:48.339579 - Application: ReportGen - Log Level: ERROR - API rate limit exceeded.:::" +
                "2024-12-10 16:16:52.127835 - Application: UserAuthService - Log Level: INFO - Data validation successful for record batch. BatchID: 4656:::" +
                "2024-12-10 16:27:28.127455 - Application: UserAuthService - Log Level: INFO - File upload started successfully. FileID: 4897:::" +
                "2024-12-10 16:30:37.128409 - Application: APIClient - Log Level: DEBUG - File upload completed successfully. FileID: 4375:::" +
                "2024-12-10 17:19:34.339629 - Application: JavaCoreApp - Log Level: DEBUG - Cache cleared.:::" +
                "2024-12-10 17:19:41.339658 - Application: APIClient - Log Level: CRITICAL - Starting synchronization process.:::" +
                "2024-12-10 16:22:57.339682 - Application: WebScraperX - Log Level: ERROR - Retrying connection...:::" +
                "2024-12-10 16:11:55.128135 - Application: ReportGen - Log Level: WARNING - Critical failure in processing task. ErrorID: 7855:::" +
                "2024-12-10 16:11:58.128819 - Application: APIClient - Log Level: INFO - Connection established with server. SessionID: 7940:::" +
                "2024-12-10 16:12:03.127485 - Application: WebScraperX - Log Level: DEBUG - User logout successful. UserID: 9716:::" +
                "2024-12-10 15:59:12.339697 - Application: JavaCoreApp - Log Level: INFO - Connection established with the external API.:::" +
                "2024-12-10 15:27:21.128872 - Application: DataSyncPro - Log Level: INFO - Data validation successful for record batch. BatchID: 8609:::" +
                "2024-12-10 16:35:40.339734 - Application: DataSyncPro - Log Level: INFO - File downloaded successfully.:::" +
                "2024-12-10 15:47:03.339765 - Application: ReportGen - Log Level: WARNING - Unexpected response from the server.:::" +
                "2024-12-10 15:20:03.129041 - Application: ReportGen - Log Level: INFO - Cache cleared successfully. CacheID: 7612:::" +
                "2024-12-10 15:21:17.128192 - Application: WebScraperX - Log Level: INFO - User login successful. UserID: 9132:::" +
                "2024-12-10 15:30:15.339786 - Application: WebScraperX - Log Level: DEBUG - Background task completed.:::" +
                "2024-12-10 17:13:48.339809 - Application: UserAuthService - Log Level: INFO - User logged in successfully.:::" +
                "2024-12-10 15:45:08.339993 - Application: APIClient - Log Level: INFO - Starting upload...:::" +
                "2024-12-10 16:12:06.339828 - Application: JavaCoreApp - Log Level: INFO - Starting synchronization process.:::" +
        ...
        filterLogs(serverLogs, "JavaCoreApp", LogLevel.CRITICAL, LogLevel.ERROR );


    }

    public static String[] splitLogs(String logs) {
        return logs.split(":::");
    }

    public static void filterLogs(String logs, String targetString) {

        for (String log : splitLogs(logs)) {

            if (log.contains(targetString)) {
    ...
    public static void filterLogs(String logs, String targetString, LogLevel... levels) {
